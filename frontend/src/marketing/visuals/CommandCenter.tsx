    ...
    return (
        <aside className="mkt-command" aria-label="Supreme Governance Command Center preview">
            ...
            <div className="mkt-command-grid">
                ...
                <div className="mkt-tile">
                    <p className="mkt-tile-label">Needs attention</p>
                ...
                <div className="mkt-tile">
                    <p className="mkt-tile-label">Compliance</p>
                ...
                <div className="mkt-tile">
                    <p className="mkt-tile-label">AI / Privacy risk</p>
                ...
                <div className="mkt-tile">
                    <p className="mkt-tile-label">Control effectiveness</p>
