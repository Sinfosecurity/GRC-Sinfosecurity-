...
export const intakeAPI = {
    ...
    createFindingCandidate: (id: string, data: unknown) => api.post(`/tprm/engagements/${id}/finding-candidates`, data),
    ...
    resolveLegacyOnboard: (id: string) => api.get(`/tprm/legacy-onboard/${id}`),
...
export const vendorOnboardingAPI = {
    ...
    confirmPlan: (id: string, data?: unknown) => api.post(`/vendors/onboarding/${id}/plan/confirm`, data || {}),
    markInvitationShared: (id: string) => api.post(`/vendors/onboarding/${id}/invitation/shared`),
    ...
    activationLink: (id: string, data?: unknown) => api.post(`/vendors/onboarding/${id}/invitation/link`, data || {}),
