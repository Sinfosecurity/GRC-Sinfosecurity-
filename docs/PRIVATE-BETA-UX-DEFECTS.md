...
| UX-031 | P1 | Hosted Reports assessment selector showed many identical `Supreme Investigation · INITIAL_DUE_DILIGENCE` rows. No prior selector remediation had been committed. Hosted remediations `7bf040a` (frontend) / `8a3d8fc` (API) humanize types, show current vs history, label templates, and 409 open duplicates. Product Leadership re-review required. |
