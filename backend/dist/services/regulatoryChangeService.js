...
// In-memory storage
const regulatoryChanges = new Map();
const frameworkUpdates = new Map();
const complianceAlerts = new Map();
...
exports.default = new RegulatoryChangeService();
//# sourceMappingURL=regulatoryChangeService.js.map