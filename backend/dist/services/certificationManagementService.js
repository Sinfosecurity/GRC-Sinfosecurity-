...
class CertificationManagementService {
     ...
     */
    updateStatus(certId, status, data) {
        ...
        if (data) {
            if (data.certifiedDate)
                cert.certifiedDate = data.certifiedDate;
            if (data.expiryDate)
     ...
     */
    updateReadiness(certId, score, gaps) {
        const cert = certifications.get(certId);
        if (!cert)
            return false;
     ...
     */
    updateMilestone(milestoneKey, status) {
...
exports.default = new CertificationManagementService();
//# sourceMappingURL=certificationManagementService.js.map