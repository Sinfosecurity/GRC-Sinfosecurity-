...
export const AUTHORITATIVE_TABLES = [
    ...
    'BusinessUnit',
    'EnterpriseRisk',
    'EnterpriseRiskCustomCategory',
    'EnterpriseRiskMethodology',
    'EnterpriseRiskImpact',
    'EnterpriseRiskScoreSnapshot',
    'EnterpriseRiskAppetite',
    'EnterpriseRiskTreatment',
    'EnterpriseRiskTreatmentAction',
    'EnterpriseRiskDecision',
    'EnterpriseRiskControlLink',
    'EnterpriseRiskFindingLink',
    'EnterpriseRiskRelationship',
    'EnterpriseRiskKri',
    'EnterpriseRiskKriMeasurement',
    'EnterpriseRiskEvent',
    ...
    'PrivacyLawfulBasis',
    'PrivacyActivityData',
    'PrivacyActivitySubject',
    'PrivacyActivityParty',
    'PrivacyTransfer',
    'PrivacyTransferAssessment',
    'PrivacyDpia',
    'PrivacyDpiaScreening',
    ...
    'InsuranceAiContext',
    'InsuranceApplicabilityDecision',
    'InsuranceDelegatedAuthority',
    'InsuranceCounterparty',
] as const;
