...
// In-memory storage
const dsrRequests = new Map<string, DataSubjectRequest>();
const dataMappings = new Map<string, DataMapping>();
const piaAssessments = new Map<string, PrivacyImpactAssessment>();
