...
import iraRoutes from './routes/ira.routes';
import intakeInfoRoutes from './routes/intakeInfo.routes';
...
app.use(`${API_PREFIX}/ira`, iraRoutes);
app.use(`${API_PREFIX}/intake-info`, intakeInfoRoutes);
