...
export const PERMISSIONS = {
    ...
    'engagement.activate': 'engagement.activate',
    ...
    'monitoring.triage': 'monitoring.triage',
    'monitoring.escalate': 'monitoring.escalate',
    'reassessment.read': 'reassessment.read',
    'reassessment.initiate': 'reassessment.initiate',
    'reassessment.manage': 'reassessment.manage',
    'offboarding.read': 'offboarding.read',
    'offboarding.manage': 'offboarding.manage',
    'offboarding.complete': 'offboarding.complete',
    'offboarding.exception': 'offboarding.exception',
...
const ROLE_PERMISSIONS: Record<CanonicalRole, Permission[]> = {
    ...
    RISK_MANAGER: [
        ...
        PERMISSIONS['engagement.activate'],
        ...
        PERMISSIONS['monitoring.triage'],
        PERMISSIONS['monitoring.escalate'],
        PERMISSIONS['reassessment.initiate'],
        PERMISSIONS['reassessment.manage'],
        PERMISSIONS['offboarding.manage'],
        PERMISSIONS['offboarding.complete'],
        PERMISSIONS['offboarding.exception'],
